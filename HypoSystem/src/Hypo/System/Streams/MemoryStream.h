...
namespace Hypo {
	...
	class HYPO_SYSTEM_API MemoryIOS : public virtual std::ios
	...
	class HYPO_SYSTEM_API MemoryInputStream : public MemoryIOS, public std::istream
	...
	class HYPO_SYSTEM_API MemoryOutputStream : public MemoryIOS, public std::ostream
		/// An input stream for reading from a memory area.
	{
	public:
